...
from himloco_lab.rsl_rl import HIMMixOnPolicyRunner, HimmixVecEnvWrapper
from himloco_lab.rsl_rl.config import HIMMixOnPolicyRunnerCfg
...
def main(env_cfg: ManagerBasedRLEnvCfg, agent_cfg: HIMMixOnPolicyRunnerCfg):
    ...
    log_root_path = os.path.join("logs", "himmix_rsl_rl", agent_cfg.experiment_name)
    ...
    runner = HIMMixOnPolicyRunner(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
